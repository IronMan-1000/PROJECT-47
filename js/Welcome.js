class Welcome {
  ...
  handleOnpress() {
    ...
    this.instructionButton.mousePressed(() => {
      swal({
        title: "INSTRUCTIONS",
        text: "USE THE UP ARROW KEY TO MOVE AHEAD AND LEFT AND RIGHT ARROW KEY TO MOVE LEFT & RIGHT. PRESS THE SPACEBAR TO INCREASE THE SPEED. COLLECT THE AVENGERS STAR TO INCREASE YOUR SCORE. ALL THE BEST!!", 
        imageUrl:
